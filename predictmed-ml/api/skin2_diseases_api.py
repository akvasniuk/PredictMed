...
classes = ['Akne', 'Benign','Enfeksiyonel','Malign','Ekzama', 'Pigment']

skin2_diseases_router = APIRouter()
...
@skin2_diseases_router.post("/predict")
async def predict_skin2_diseases(file: UploadFile=File(...)):
    try:
